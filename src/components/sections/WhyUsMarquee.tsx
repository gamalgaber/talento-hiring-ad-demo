...
export default function WhyUsMarquee() {
  ...
  return (
    <section className="bg-talento-primary-50">
      <div className="mx-auto max-w-7xl overflow-x-hidden px-4 sm:px-6 py-8 lg:py-16">
        <div className="mx-auto mb-4 lg:mb-8 max-w-2xl lg:px-6 text-left rtl:lg:text-center rtl:text-right lg:text-center">
          <Reveal>
